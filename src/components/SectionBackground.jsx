...
function CircuitPattern() {
  return (
    <g opacity="0.5" stroke="rgba(129, 140, 248, 0.35)" strokeWidth="2" fill="none">
      ...
      <circle className="pulse" cx="220" cy="160" r="6" fill="rgba(129, 140, 248, 0.6)" stroke="none" />
      <circle className="pulse" cx="420" cy="160" r="6" fill="rgba(129, 140, 248, 0.6)" stroke="none" />
      <circle className="pulse" cx="980" cy="460" r="6" fill="rgba(129, 140, 248, 0.6)" stroke="none" />
      <circle className="pulse" cx="300" cy="580" r="6" fill="rgba(129, 140, 248, 0.6)" stroke="none" />
...
function HexPattern() {
  ...
  return (
    <g fill="none" stroke="rgba(129, 140, 248, 0.3)" strokeWidth="2">
  ...
  return (
    <g fill="none">
      <g transform="translate(950,90)" className="drift">
        <path d="M0 20 L90 0 L180 20 L90 40 Z" fill="rgba(129, 140, 248, 0.18)" stroke="rgba(129, 140, 248, 0.35)" strokeWidth="2" />
        <path d="M40 32 L40 62 Q90 82 140 62 L140 32" stroke="rgba(129, 140, 248, 0.3)" strokeWidth="2" />
        <line x1="170" y1="18" x2="170" y2="60" stroke="rgba(129, 140, 248, 0.35)" strokeWidth="2" />
        <circle cx="170" cy="64" r="4" fill="rgba(129, 140, 248, 0.5)" />
      </g>
      <g transform="translate(70,520)" className="drift" style={{ animationDelay: '1.5s' }}>
        <path d="M0 16 L70 0 L140 16 L70 32 Z" fill="rgba(129, 140, 248, 0.14)" stroke="rgba(129, 140, 248, 0.28)" strokeWidth="2" />
      </g>
      <circle cx="600" cy="120" r="3" fill="rgba(129, 140, 248, 0.4)" className="pulse" />
      <circle cx="700" cy="600" r="3" fill="rgba(129, 140, 248, 0.4)" className="pulse" />
    </g>
  )
}
...
function SignalPattern() {
  return (
    <g fill="none" stroke="rgba(129, 140, 248, 0.3)" strokeWidth="2">
      ...
      <circle cx="1050" cy="150" r="4" fill="rgba(129, 140, 248, 0.6)" stroke="none" />
...
function BinaryPattern() {
  ...
  return (
    <g fontFamily="ui-monospace, monospace" fontSize="16" fill="rgba(129, 140, 248, 0.25)">
      {bits.map((b, i) => (
